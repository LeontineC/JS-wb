function Gallery(gallery) {
  ...
  //binding this
  this.showNextImage = this.showNextImage.bind(this); //at eventListener this points to button not image
...
Gallery.prototype.showImage = function (el) {
  ...
  this.modal.querySelector("h4").textContent = el.dataset.description;
  this.currentImage = el;
  this.openModal();
};
const gallery1 = new Gallery(document.querySelector(".gallery1"));
const gallery2 = new Gallery(document.querySelector(".gallery2"));
//new creates instanceof
